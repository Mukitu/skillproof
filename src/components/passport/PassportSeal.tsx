interface PassportSealProps {
  size?: number;
  /** 'full' (full-color with ribbon) or 'compact' (just the rosette). */
  variant?: 'full' | 'compact';
  className?: string;
  /** Subtle pulse animation for the active verified state. */
  animated?: boolean;
}

/**
 * The SkillProof Official Seal — a self-contained SVG with no external
 * assets. Used in the passport card header and on the dashboard mini-card.
 */
