  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.error) {
        ...
        setSuccessMsg(
          language === 'bn'
            ? 'পাসওয়ার্ড রিসেট লিঙ্ক আপনার ইমেইলে পাঠানো হয়েছে! অনুগ্রহ করে ইনবক্স চেক করুন।'
        ...
        <div className="max-w-md w-full bg-white border border-red-100 p-8 rounded-3xl shadow-xl space-y-6">
          <div className="text-center space-y-2">
            ...
            <p className="text-xs text-slate-500">
              {language === 'bn'
                ? 'আপনার ইমেইল দিন, আমরা আপনাকে পাসওয়ার্ড রিসেট লিঙ্ক পাঠাব'
          ...
          <p className="text-center text-xs text-slate-500">
            {language === 'bn' ? 'মনে পড়েছে? ' : 'Remember your password? '}
